...
<body>
    <div class="wrapper">
        ...
        <form class="form-be" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <input type="password" name="password" class="form-control" value="<?php echo $password; ?>">
                <label><span class="content-name">Password</span></label>
            </div>
            <span class="help-block"><?php echo $password_err; ?></span>

            <div class=" form form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <input type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>">
                <label><span class="content-name">Confirm Password</span></label>
            </div>
